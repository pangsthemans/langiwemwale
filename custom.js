...
function typer() {
    var win = $(window),
            foo = $('#typer');
    foo.typer(['<h2><span class="text-color-1">Web</span> Developer</h2>', '<h2>Web <span class="text-color-1">Designer</span></h2>', '<h2><span class="text-color-1">Frontend</span> Developer</h2>']);
}
